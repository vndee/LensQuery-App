...
export default new LocalizedStrings({
  ...
  en: {
    ...
    paywall: {
      ...
      purchase: 'Purchase',
      youWillReceived: 'You will received',
      queryCredit: 'query credit',
      freeTextSnap: 'text snap',
      equationTextSnap: 'equation text snap',
      gpt35Token: 'GPT-3.5 usage token(s)',
      gpt4Token: 'GPT-4 usage token(s)',
      llamaToken: 'Llama-13b usage token(s)',
      thisMeanYouHave: 'This mean you will have..',
    }
  },
  // Vietnamese
  vi: {
    ...
    paywall: {
      ...
      purchase: 'Mua gói',
      youWillReceived: 'Bạn sẽ nhận được',
      queryCredit: 'query credit',
      freeTextSnap: 'text snap',
      equationTextSnap: 'equation text snap',
      gpt35Token: 'GPT-3.5 usage token(s)',
      gpt4Token: 'GPT-4 usage token(s)',
      llamaToken: 'Llama-13b usage token(s)',
      thisMeanYouHave: 'Tương đương với..'
    }
  },
});